    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <form id="caseForm" method="POST">
                ...
                <!--                                                   value="-->
                <?php //echo $objForm->stickyText('last_name'); ?><!--">-->
                <!--                                        </div>-->
                <!--                                    </div>-->
                <!---->
                <!--                                    <div class="form-group row">-->
                ...
                <!--                                                   value="-->
                <?php //echo $objForm->stickyText('address_1'); ?><!--">-->
                <!--                                        </div>-->
                <!--                                    </div>-->
                <!---->
                <!---->
                ...
                <!--                                                   value="-->
                <?php //echo $objForm->stickyText('address_2'); ?><!--">-->
                <!--                                        </div>-->
                <!--                                    </div>-->
                <!---->
                <!---->
                ...
                <?php //echo $objForm->stickyText('town'); ?><!--">-->
                <!--                                        </div>-->
                <!--                                    </div>-->
                <!---->
                <!---->
                ...
                <?php //echo $objForm->stickyText('county'); ?><!--">-->
                <!--                                        </div>-->
                <!--                                    </div>-->
                <!---->
                <!--                                    <div class="form-group row">-->
                ...
                <?php //echo $objForm->stickyText('email'); ?><!--">-->
                <!--                                        </div>-->
                <!--                                    </div>-->
                <!---->
                <!--                                    <div class="form-group row">-->
                ...
                <!--                                                   value="-->
                <?php //echo $objForm->stickyText('password'); ?><!--">-->
                <!--                                        </div>-->
                <!--                                    </div>-->
                <!---->
                <!---->
                ...
                <?php //echo $objForm->stickyText('confirm_password'); ?><!--">-->
                <!--                                        </div>-->
                <!--                                    </div>-->
